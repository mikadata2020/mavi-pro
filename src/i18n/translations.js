...
export const translations = {
    ...
    jp: {
        ...
        videoWorkspace: {
            ...
            dragDrop: 'ビデオをドラッグ＆ドロップまたはクリックして選択',
            playPause: '再生/一時停止',
            speed: '速度',
            volume: '音量',
            fullscreen: '全画面',
        ...
        waste: {
            ...
            analyze: '分析',
            eliminate: '排除',
            noWaste: '無駄は特定されていません',
            wasteFound: '無駄が見つかりました'
        },
        statistics: {
            title: '統計分析',
            mean: '平均',
