    ...
    const workflowSteps = [
        {
            ...
            details: [
                ...
                'Atau record langsung dengan webcam'
            ],
            features: ['Video Workspace', 'IP Camera Connect', 'Video Recorder']
        },
        {
            id: 2,
            ...
            details: [
                ...
                'Gunakan Voice Commands untuk hands-free'
            ],
            features: ['Timeline Measurement', 'Voice Commands', 'Auto Cycle Detection']
        },
        {
            id: 3,
        ...
        },
        {
            ...
            details: [
                ...
                'Voice Dictate untuk input suara',
                'Markup gambar dengan annotations',
                'Export PDF/Word/PowerPoint'
            ],
            features: ['Manual Creation', 'AI Generate', 'Voice Dictation']
        },
        {
            id: 6,
